...
GitHub Actions |
:---: |
[![GitHub Actions](https://github.com/nikoyak/FSharp.Serilog/workflows/Build%20main/badge.svg)](https://github.com/nikoyak/FSharp.Serilog/actions?query=branch%3Amain) |
[![Build History](https://buildstats.info/github/chart/nikoyak/FSharp.Serilog)](https://github.com/nikoyak/FSharp.Serilog/actions?query=branch%3Amain) |

## NuGet

Package | Stable | Prerelease
--- | --- | ---
FSharp.Serilog | [![NuGet Badge](https://buildstats.info/nuget/FSharp.Serilog)](https://www.nuget.org/packages/FSharp.Serilog/) | [![NuGet Badge](https://buildstats.info/nuget/FSharp.Serilog?includePreReleases=true)](https://www.nuget.org/packages/FSharp.Serilog/)
...
```
$ tree src/FSharp.Serilog/bin/
src/FSharp.Serilog/bin/
└── Debug
    └── net6.0
        ├── FSharp.Serilog.deps.json
        ├── FSharp.Serilog.dll
        ├── FSharp.Serilog.pdb
        └── FSharp.Serilog.xml
...
git branch -M main
git remote add origin https://github.com/nikoyak/FSharp.Serilog.git
git push -u origin main
```

- [Create your NuGeT API key](https://docs.microsoft.com/en-us/nuget/nuget-org/publish-a-package#create-api-keys)
    - Add your NuGet API key as repository secret NUGET_TOKEN to [Actions secrets](https://github.com/nikoyak/FSharp.Serilog/settings/secrets/actions)
...
[Unreleased]: https://github.com/nikoyak/FSharp.Serilog/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/nikoyak/FSharp.Serilog/releases/tag/v0.1.0
```
...
- The [Github Action](https://github.com/nikoyak/FSharp.Serilog/blob/main/.github/workflows/publish.yml) will handle the new tag:
...
- Set Source for "Build and deployment" on [GitHub Pages](https://github.com/nikoyak/FSharp.Serilog/settings/pages) to `GitHub Actions`.
- Documentation is auto-deployed via [Github Action](https://github.com/nikoyak/FSharp.Serilog/blob/main/.github/workflows/fsdocs-gh-pages.yml) to [Your GitHub Page](https://nikoyak.github.io/FSharp.Serilog/)
